...
#pragma HLS INTERFACE m_axi port = out_0_o bundle = gmem4
#pragma HLS INTERFACE m_axi port = out_1_o bundle = gmem5

#pragma HLS INTERFACE s_axilite port = seq_i
#pragma HLS INTERFACE s_axilite port = out_0_o
#pragma HLS INTERFACE s_axilite port = out_1_o
