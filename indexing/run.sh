...
make
./demeter_index -w 10 -f 500 -k 15 -b 30 /mnt/scratch/jeudine/GCA_000001405.15_GRCh38_no_alt_analysis_set.fasta /mnt/scratch/jeudine/GRC38_w10_k15_f200_b30.dti
