...
pbsim --strategy wgs --method errhmm -errhmm $DATA/ERRHMM-ONT.model --depth 0.1 --genome $DATA/GCA_000001405.15_GRCh38_no_alt_analysis_set.fasta --seed 23 --length-min 10000 --length-max 100000
